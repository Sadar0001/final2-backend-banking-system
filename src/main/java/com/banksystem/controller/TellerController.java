...
public class TellerController {
    ...
    public TellerController(TellerService tellerService, JwtHelperService jwtHelper, TransactionService transactionService) {
    ...
    public ResponseEntity<ApiResponse<Transaction>> performTransaction(
            @RequestHeader("Authorization") String authHeader,
        ...
        // Set context: This is a teller-initiated action
        transactionDto.setAccountHolderType(AccountHolderType.TELLER);

        log.info("Teller {} initiating {} of ₹{}", tellerId, transactionDto.getTransactionType(), transactionDto.getAmount());
        Transaction transaction = transactionService.makeTransaction(transactionDto);

        return ResponseEntity.status(HttpStatus.ACCEPTED)
                .body(ApiResponse.success("Transaction processed successfully", transaction));
    }
    // ==================== DEBIT CARD REQUESTS ====================
